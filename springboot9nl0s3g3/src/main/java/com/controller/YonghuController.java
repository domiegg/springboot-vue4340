...
public class YonghuController {
    ...
    public R sendemailpassword(@RequestParam String email, @RequestParam String username, @RequestParam int type){
        ...
        if(type==1) {
            sb.append("http://localhost:8080/springboot9nl0s3g3/admin/dist/index.html#/register?pageFlag=security1&email="+email+"&username="+username+"&tablename=yonghu"+ "\r\n");
        } else {
            sb.append("http://localhost:8080/springboot9nl0s3g3/front/dist/index.html#/register?pageFlag=security1&email="+email+"&username="+username+"&tablename=yonghu"+ "\r\n");
        }
