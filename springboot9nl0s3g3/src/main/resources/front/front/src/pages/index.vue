	...
	<div class="main-containers">
		...
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(64, 158, 255, .3)","padding":"0px 10%","borderColor":"#eee","color":"#fff","alignItems":"center","textAlign":"right","display":"flex","justifyContent":"flex-end","top":"0","left":"0","background":"rgba(0,0,0,0.5)","borderWidth":"0px","width":"100%","fontSize":"14px","position":"absolute","borderStyle":"solid","height":"80px","zIndex":"1002"}'>
			...
			<div :style='{"margin":"0","position":"absolute","top":"22px","float":"left","left":"10%","display":"inline-block"}'>
			  <span @click="goMenu('/index/home')" :style='{"padding":"0px","lineHeight":"32px","fontSize":"24px","color":"#F7C420","fontWeight":"500"}'>基于springboot的商场多功能折扣系统</span>
			</div>
...
export default {
    data() {
		return {
            activeIndex: '0',
			roleMenus: [{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-goods","buttons":["新增","查看","修改","删除"],"menu":"用户","menuJump":"列表","tableName":"yonghu"}],"menu":"用户管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-send","buttons":["新增","查看","修改","删除"],"menu":"商品分类","menuJump":"列表","tableName":"shangpinfenlei"}],"menu":"商品分类管理"},{"child":[{"allButtons":["新增","查看","修改","删除","查看评论"],"appFrontIcon":"cuIcon-goods","buttons":["新增","查看","修改","删除","查看评论"],"menu":"商品信息","menuJump":"列表","tableName":"shangpinxinxi"}],"menu":"商品信息管理"},{"child":[{"allButtons":["新增","查看","修改","删除","查看评论"],"appFrontIcon":"cuIcon-cardboard","buttons":["新增","查看","修改","删除","查看评论"],"menu":"积分商品","menuJump":"列表","tableName":"jifenshangpin"}],"menu":"积分商品管理"},{"child":[{"allButtons":["新增","查看","修改","删除","抽奖"],"appFrontIcon":"cuIcon-vipcard","buttons":["新增","查看","修改","删除"],"menu":"抽奖活动","menuJump":"列表","tableName":"choujianghuodong"}],"menu":"抽奖活动管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-list","buttons":["查看","删除"],"menu":"抽奖记录","menuJump":"列表","tableName":"choujiangjilu"}],"menu":"抽奖记录管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-rank","buttons":["新增","查看","修改","删除"],"menu":"今日活动","menuJump":"列表","tableName":"jinrihuodong"}],"menu":"今日活动管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-time","buttons":["新增","查看","修改","删除"],"menu":"优惠券","tableName":"coupon"}],"menu":"优惠券管理"},{"child":[{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-goodsnew","buttons":["查看","修改"],"menu":"系统简介","tableName":"systemintro"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-goods","buttons":["新增","查看","修改","删除"],"menu":"轮播图管理","tableName":"config"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告信息","tableName":"news"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告信息分类","tableName":"newstype"},{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-flashlightopen","buttons":["查看","修改"],"menu":"关于我们","tableName":"aboutus"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-service","buttons":["新增","查看","修改","删除"],"menu":"在线客服","tableName":"chat"}],"menu":"系统管理"},{"child":[{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","发货","物流","核销"],"appFrontIcon":"cuIcon-taxi","buttons":["查看","发货"],"menu":"已支付订单","tableName":"orders/已支付"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","物流","退货审核"],"appFrontIcon":"cuIcon-keyboard","buttons":["查看","退货审核","日销量","月销量","品销量","日销额","月销额","品销额"],"menu":"已完成订单","tableName":"orders/已完成"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","物流"],"appFrontIcon":"cuIcon-list","buttons":["查看"],"menu":"已退款订单","tableName":"orders/已退款"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","确认收货","物流"],"appFrontIcon":"cuIcon-circle","buttons":["查看","物流"],"menu":"已发货订单","tableName":"orders/已发货"}],"menu":"订单管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","查看评论"],"appFrontIcon":"cuIcon-newshot","buttons":["查看"],"menu":"商品信息列表","menuJump":"列表","tableName":"shangpinxinxi"}],"menu":"商品信息模块"},{"child":[{"allButtons":["新增","查看","修改","删除","查看评论"],"appFrontIcon":"cuIcon-keyboard","buttons":["查看"],"menu":"积分商品列表","menuJump":"列表","tableName":"jifenshangpin"}],"menu":"积分商品模块"},{"child":[{"allButtons":["新增","查看","修改","删除","抽奖"],"appFrontIcon":"cuIcon-clothes","buttons":["查看","抽奖"],"menu":"抽奖活动列表","menuJump":"列表","tableName":"choujianghuodong"}],"menu":"抽奖活动模块"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-shop","buttons":["查看"],"menu":"今日活动列表","menuJump":"列表","tableName":"jinrihuodong"}],"menu":"今日活动模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"管理员","tableName":"users"},{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-list","buttons":["查看"],"menu":"抽奖记录","menuJump":"列表","tableName":"choujiangjilu"}],"menu":"抽奖记录管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","查看评论"],"appFrontIcon":"cuIcon-newshot","buttons":["查看"],"menu":"商品信息列表","menuJump":"列表","tableName":"shangpinxinxi"}],"menu":"商品信息模块"},{"child":[{"allButtons":["新增","查看","修改","删除","查看评论"],"appFrontIcon":"cuIcon-keyboard","buttons":["查看"],"menu":"积分商品列表","menuJump":"列表","tableName":"jifenshangpin"}],"menu":"积分商品模块"},{"child":[{"allButtons":["新增","查看","修改","删除","抽奖"],"appFrontIcon":"cuIcon-clothes","buttons":["查看","抽奖"],"menu":"抽奖活动列表","menuJump":"列表","tableName":"choujianghuodong"}],"menu":"抽奖活动模块"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-shop","buttons":["查看"],"menu":"今日活动列表","menuJump":"列表","tableName":"jinrihuodong"}],"menu":"今日活动模块"}],"hasBackLogin":"否","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"用户","tableName":"yonghu"}],
			baseUrl: '',
			carouselList: [],
			menuList: [],
