	...
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0 30px","background":"#fff"}'>
		...
		>
			<template v-show="logistics">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="统一订单编号" prop="orderno">
					<el-input v-model="ruleForm.orderno" placeholder="统一订单编号" clearable  :readonly="ro.orderno"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="统一订单编号" prop="orderno">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../springboot9nl0s3g3/upload');
        } else {
