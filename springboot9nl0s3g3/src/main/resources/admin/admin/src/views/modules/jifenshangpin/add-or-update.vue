	...
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0 30px","background":"#fff"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="所需积分" prop="suoxujifen">
					<el-input-number v-model="ruleForm.suoxujifen" placeholder="所需积分" :disabled="ro.suoxujifen"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="所需积分" prop="suoxujifen">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="兑换规则" prop="duihuanguize">
					<el-input
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.duihuanguize" label="兑换规则" prop="duihuanguize">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.duihuanguize}}</span>
				</el-form-item>
