	...
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0 30px","background":"#fff"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="活动编号" prop="huodongbianhao">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="是否中奖" prop="shifouzhongjiang">
					<el-input v-model="ruleForm.shifouzhongjiang" placeholder="是否中奖" clearable  :readonly="ro.shifouzhongjiang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="是否中奖" prop="shifouzhongjiang">
					<el-input v-model="ruleForm.shifouzhongjiang" placeholder="是否中奖" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="奖品名称" prop="jiangpinmingcheng">
					<el-input v-model="ruleForm.jiangpinmingcheng" placeholder="奖品名称" clearable  :readonly="ro.jiangpinmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="奖品名称" prop="jiangpinmingcheng">
